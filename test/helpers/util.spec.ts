...
describe('helpers::util', () => {
  ...
  describe('extend', () => {
    ...
    test('should extend properties', () => {
      ...
      const b = { bar: 789, baz: 111 }
      const c = extend(a, b)
      expect(c.foo).toEqual(123)
      expect(c.bar).toEqual(789)
      expect(c.baz).toEqual(111)
    })
  })
  ...
  describe('deepMerge', () => {
    ...
    test('should deepMerge recursively', () => {
      ...
      expect(c.foo.bar).toEqual(123)
      expect(c.foo.baz).toEqual(456)
      expect(c.bar.qux).toEqual(789)
    })

    test('should deepMerge recursively and replace correctly', () => {
      const a = { foo: { bar: 123 } }
      const b = { foo: 'halo' }
      const c = deepMerge(a, b)
      expect(c.foo).toEqual('halo')
    })
    ...
    test('should handle null and undefined arguments correctly', () => {
